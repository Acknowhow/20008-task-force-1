    ...
    <header class="page-header">
        <div class="main-container page-header__container">
            ...
            <div class="header__nav">
                ...
                $links = [
                    'Задания' => '#', 'Исполнители' => '#',
                    'Создать задание' => '#', 'Мой профиль' => '#'
                ];
                echo Html::ul($links, ['item' => function($item, $index) {

                    return "<li class='site-list__item'>
                        <a href='#'>" . Html::encode($index) . "</a></li>";},
            ...
            <div class="lightbulb__pop-up">
                <h3 class="lightbulb__heading">Новые события</h3>
